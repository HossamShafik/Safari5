...
class _HotelsDetailsScreenState extends State<HotelsDetailsScreen>
  ...
  Future<DocumentSnapshot> getData() async {
    try {
      ...
      travelerCollection.doc(firebaseUser.uid).get().then((value) {
          ...
          Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () {
                  Navigator.pop(context,favoriteSelect);
                },
              ),
            ),
            body: Column(
  ...
  Future addFavorite()async{
    ...
    await DataBase().addFavoritesHotel(FavoriteHotel(
      uid: currentUser,
      hotelId: widget.hotel.hotelId,
      fav: favoriteSelect,
      image: widget.hotel.images[0],
      hotelName: widget.hotel.hotelName,
      hotelCountry: widget.hotel.hotelCountry,
      hotelCity: widget.hotel.hotelCity,
      rate: widget.hotel.hotelRate,
      price: widget.hotel.priceOfDay,
                              ...
                              onPressed: () async {
                                if (_formKey.currentState.validate()) {
                                  await addReview().then((_) {
                                    ...
                                    _scaffoldKey.currentState.showSnackBar(SnackBar(content: Text("Your Review Added Success")));
                                  }).catchError((error) {
                                    _scaffoldKey.currentState.showSnackBar(SnackBar(content: Text("Your Review Added Failed $error")));
                                  });
                                }
                              },
                              child: Text(
